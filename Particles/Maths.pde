static double lerp(double  t, double v1, double v2){ return (1.0f - t) * v1 + t * v2;}
    ...
    public static int NextInt(int prob) {
    ...
    NumberSequance Shuffle(int times) {
        ...
        for (int t = 0; t < times; t++) {
            ...
            switch (i) {
                ...
                case 6: {
                    even.Reverse();
                    result = odd.Inserted(even,NextInt(odd.length));//cut

                    break;
                }
                case 7: {
                    odd.Reverse();
                    result = even.Inserted(odd, NextInt(even.length));//cut
                ...
                case 10: {
                    result = odd.Inserted(even, NextInt(odd.length)).Reversed();//cut

                    break;
                }
                case 11: {
                    result = even.Inserted(odd, NextInt(even.length)).Reversed();//cut
                ...
                case 18: {
                    even.Reverse();
                    result = odd.Intergrated(even, NextInt(odd.length));//cut

                    break;
                }
                case 19: {
                    odd.Reverse();
                    result = even.Intergrated(odd, NextInt(even.length));//cut
                ...
                case 22: {
                    result = odd.Intergrated(even, NextInt(odd.length)).Reversed();//cut

                    break;
                }
                case 23: {
                    result = even.Intergrated(odd, NextInt(even.length)).Reversed();//cut
        ...
        switch (i) {
            ...
            case 2: {
                result = even.Inserted(odd.Reversed(), NextInt(even.length));//cut
                break;
            }
            case 3: {
                result = odd.Inserted(even.Reversed(), NextInt(odd.length));//cut
                break;
            }
            case 4: {
                result = even.Inserted(odd, NextInt(even.length));//cut
        ...
        return even.Inserted(odd, NextInt(even.length));//final cut
    }
...
class IntegralOperation extends RingList<NumberSequance> {
    ...
    double f(double x){return 0.5*x*x;}
    };// = (x) -> 0.5 * x * x;
